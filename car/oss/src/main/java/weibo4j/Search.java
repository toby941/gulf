...
public class Search extends Weibo {
    ...
    public static void main(String[] args) throws WeiboException {
        ...
        search.setToken("2.00ph6iiBHV6_qD71b4f7f94bVf9iDC");
        JSONArray jsonArray = search.searchLimited("iphone");
        System.out.println(jsonArray);
    }

    public JSONArray searchLimited(String q) throws WeiboException {
        return client.get("http://api.t.sina.com.cn/search.json", new PostParameter[]{new PostParameter("q", q)})
                .asJSONArray();
    }
