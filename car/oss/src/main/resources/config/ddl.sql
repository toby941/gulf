...
CREATE TABLE `GULF_NEWS` (
  ...
  `CONTENT_HTML` text CHARACTER SET latin1,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='文章表';


CREATE TABLE `IMAGE` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `URL` varchar(200) COLLATE utf8_bin NOT NULL,
  `IMAGE_TYPE` int(2) DEFAULT NULL COMMENT '图片类型 按新闻类型区分',
  `ADD_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`)
